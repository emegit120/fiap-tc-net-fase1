...
namespace FIAPTechChallenge.Migrations
{
    ...
    [Migration("20250602235833_PromotionGameManyToMany")]
    partial class PromotionGameManyToMany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GamePromotion", b =>
                {
                    ...
                    b.HasOne("FIAPTechChallenge.Domain.Entities.Promotion", null)
                        .WithMany()
